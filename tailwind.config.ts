...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "glow-conic": "conic-gradient(from 0deg at 50% 50%, #00D4FF 0deg, #7C3AED 120deg, #10b981 240deg, #00D4FF 360deg)",
      ...
      boxShadow: {
        ...
        "card-hover":   "0 8px 40px rgba(0,0,0,0.5), 0 0 30px rgba(0,212,255,0.12)",
      },
      animation: {
