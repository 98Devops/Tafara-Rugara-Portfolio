  ...
  projects: [
    ...
    },
    {
      ...
      highlights: [
        ...
        'Terraform Infrastructure as Code on AWS (Lambda, API Gateway, CloudFront, S3)',
        'GitHub Actions CI/CD pipeline: lint → test → build → deploy gates',
        'Prometheus + Grafana monitoring for dashboards and operational alerting',
    ...
    },
    {
      ...
      technicalArchitecture: 'Flask REST API with Whisper transcription, LLM reasoning, and a Qdrant vector database for storage; containerised for portability.',
      ...
      highlights: [
        ...
        'Whisper API transcription + LLM reasoning + Qdrant vector database storage',
    ...
    },
    {
      ...
      highlights: [
        ...
        'RDS + ElastiCache for fully managed data layer with improved scalability',
    ...
    },
    {
      ...
      highlights: [
        ...
        'Secure-by-default: IAM least privilege, HTTPS-only, signed CDN',
        'GitHub Actions CI/CD pipeline with full deployment gates',
        'Adopted across multiple projects — zero config drift',
      ],
      githubUrl: '',
      demoUrl: 'https://d3tr9ufxy7e85m.cloudfront.net/',
