...
const ContactForm = dynamic(() => import('@/components/ContactForm'), {
  loading: () => (
    <div className="animate-pulse space-y-4">
      {[1,2,3,4].map(i => (
        <div key={i} className="rounded-xl" style={{ height: i === 3 ? 120 : 48, background: 'rgba(0,212,255,0.06)' }} />
      ))}
    </div>
  ),
  ssr: false,
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              {/* Glow */}
              <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse at center, rgba(16,185,129,0.08), transparent 70%)' }} />

              <div className="relative z-10">
                <div className="text-4xl mb-4">📲</div>
                <h3 className="text-2xl font-bold text-white mb-3">Prefer a direct conversation?</h3>
                <p className="max-w-lg mx-auto mb-8" style={{ color: 'rgba(148,163,184,0.85)' }}>
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-sm transition-all duration-200 hover:-translate-y-1"
                    style={{
