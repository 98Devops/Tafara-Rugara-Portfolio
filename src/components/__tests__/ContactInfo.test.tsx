...
describe('ContactInfo', () => {
  it('renders contact information correctly', () => {
    ...
    expect(
      screen.getByText(/Open to Cloud & DevOps engineering roles/)
    ).toBeInTheDocument();
  });
  ...
  it('has correct links with proper attributes', () => {
    ...
    expect(linkedinLink).toHaveAttribute(
      'href',
      'https://www.linkedin.com/in/tafara-rugara-0627b819b/'
    );
    expect(githubLink).toHaveAttribute('href', 'https://github.com/98Devops');
    expect(youtubeLink).toHaveAttribute(
      'href',
      'https://www.youtube.com/@techwithtaf'
    );
  ...
  it('displays availability status', () => {
    ...
    expect(
      screen.getByText('Harare, Zimbabwe & Johannesburg, South Africa')
    ).toBeInTheDocument();
  });
  ...
  it('displays document download buttons', () => {
    ...
    expect(
      screen.getByRole('button', { name: /reference letter/i })
    ).toBeInTheDocument();
  });
