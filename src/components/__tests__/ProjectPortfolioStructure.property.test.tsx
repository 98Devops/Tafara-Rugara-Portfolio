      ...
      fc.assert(
        fc.property(
          ...
          (data: PortfolioData) => {
            ...
            expect(acquisitionsProject!.title).toBe('Acquisitions — Platform for Buying & Selling SaaS Businesses');
            ...
            expect(acquisitionsProject!.technologies.length).toBeGreaterThanOrEqual(6);
            expect(acquisitionsProject!.highlights.length).toBeGreaterThanOrEqual(5);
          }
        ),
        { numRuns: 10 }
      );
      ...
      fc.assert(
        fc.property(
          ...
          (data: PortfolioData) => {
            ...
            expect(voiceVectorProject!.title).toBe('Voice-to-Vector API (Platform Variant)');
            ...
            // Verify substantial technical content
            expect(voiceVectorProject!.technologies.length).toBeGreaterThanOrEqual(5);
            expect(voiceVectorProject!.highlights.length).toBeGreaterThanOrEqual(5);
          }
        ),
        { numRuns: 10 }
      );
      ...
      fc.assert(
        fc.property(
          ...
          (data: PortfolioData) => {
            ...
            expect(serverlessProject!.title).toBe('Serverless App Pattern — IaC & CI/CD Platform');
            ...
            // Verify substantial technical content
            expect(serverlessProject!.technologies.length).toBeGreaterThanOrEqual(5);
            expect(serverlessProject!.highlights.length).toBeGreaterThanOrEqual(5);
          }
        ),
        { numRuns: 10 }
      );
      ...
      fc.assert(
        fc.property(
          ...
          (data: PortfolioData) => {
            ...
            expect(tomcatProject!.title).toBe('Managed Legacy Migration — Platform Modernization');
        ...
        fc.property(
          ...
          (data: PortfolioData) => {
            data.projects.forEach(project => {
              ...
              const hasGithubUrl = project.githubUrl && project.githubUrl.length > 0;
        ...
        fc.property(
          ...
          (data: PortfolioData) => {
            data.projects.forEach(project => {
              ...
              if (project.githubUrl) {
                expect(project.githubUrl).toMatch(/^https:\/\/github\.com\/[\w-]+\/[\w-]+$/);
        ...
        fc.property(
          ...
          (data: PortfolioData) => {
            data.projects.forEach(project => {
              ...
              const coreTerms = ['api', 'aws', 'docker', 'kubernetes', 'terraform', 'ci/cd'];
              const hasRelevantTerms = coreTerms.some(term => combinedTechText.includes(term));
            ...
            const uniqueTechnologies = new Set(allTechnologies.map(tech => tech.toLowerCase()));
            ...
            const majorCategories = ['javascript', 'python', 'java', 'aws', 'docker', 'kubernetes'];
            const representedCategories = majorCategories.filter(cat => 
        ...
        fc.property(
          ...
          (data: PortfolioData) => {
            ...
            data.projects.forEach(project => {
              ...
              const filterableTerms = ['aws', 'api', 'serverless', 'ai', 'docker', 'kubernetes'];
            ...
            const allProjectsText = data.projects.map(p => 
      ...
      fc.assert(
        fc.property(
          ...
          (data: PortfolioData) => {
            ...
            const projectsText = data.projects.map(p => 
            ...
            const brandKeywords = ['aws', 'terraform', 'docker', 'kubernetes', 'ci/cd'];
            ...
            if (personalKeywords.includes('automation')) {
              const automationConcepts = ['ci/cd', 'pipeline', 'workflow', 'orchestration', 'deployment'];
            ...
            const capabilityKeywords = data.capabilities.flatMap(cap => 
              cap.skills.join(' ').toLowerCase().split(' ')
            ...
            expect(matchingKeywords.length).toBeGreaterThan(capabilityKeywords.length * 0.25);
            ...
            const hasAPI = projectTitles.some(title => title.toLowerCase().includes('api'));
            const hasInfrastructure = data.projects.some(p => 
              p.technologies.some(tech => 
                ['aws', 'terraform', 'kubernetes', 'docker'].includes(tech.toLowerCase())
              )
            );
