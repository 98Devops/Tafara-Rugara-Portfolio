...
test.describe('Contact Form', () => {
  ...
  test('should validate email format', async ({ page }) => {
    ...
    await page.fill('textarea[name="message"]', 'This is a test message that is long enough to be valid.');
  ...
  test('should accept valid form submission', async ({ page }) => {
    ...
    await page.fill('textarea[name="message"]', 'This is a test message with sufficient length to pass validation requirements.');
