...
test.describe('Document Downloads', () => {
  test('should provide CV download button on home page', async ({ page }) => {
    ...
    const cvDownloadButton = page.locator('a[href*="cv"], a[href*="CV"], a:has-text("Download CV")');
  ...
  test('should provide reference download button on home page', async ({ page }) => {
    await page.goto('/');
    
    const referenceDownloadButton = page.locator('a[href*="reference"], a:has-text("Download Reference")');
  ...
  test('CV download should serve PDF directly', async ({ page }) => {
    ...
    const cvDownloadButton = page.locator('a[href*="cv"], a[href*="CV"], a:has-text("Download CV")').first();
    const href = await cvDownloadButton.getAttribute('href');
  ...
  test('Reference download should serve PDF directly', async ({ page }) => {
    ...
    const referenceDownloadButton = page.locator('a[href*="reference"], a:has-text("Download Reference")').first();
    const href = await referenceDownloadButton.getAttribute('href');
  ...
  test('download buttons should have proper accessibility attributes', async ({ page }) => {
    await page.goto('/');
